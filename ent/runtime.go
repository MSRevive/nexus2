...
func init() {
	...
	characterDescFlags := characterFields[5].Descriptor()
	...
	characterDescQuickslots := characterFields[6].Descriptor()
	...
	characterDescQuests := characterFields[7].Descriptor()
	...
	characterDescKills := characterFields[9].Descriptor()
	...
	characterDescGold := characterFields[10].Descriptor()
	...
	characterDescSkills := characterFields[11].Descriptor()
	...
	characterDescPets := characterFields[12].Descriptor()
	...
	characterDescHealth := characterFields[13].Descriptor()
	...
	characterDescEquipped := characterFields[15].Descriptor()
	...
	characterDescSpells := characterFields[18].Descriptor()
	...
	characterDescSpellbook := characterFields[19].Descriptor()
	...
	characterDescBags := characterFields[20].Descriptor()
